 ...
 * @author eliez
 */
public class ModificarPro extends javax.swing.JDialog {

    static String Driver="com.microsoft.sqlserver.jdbc.SQLServerDriver";
    static String URL="jdbc:sqlserver://localhost:1433;databaseName=cafeteria";
    static String user="sa";
    static String pass="Eliezer";
    static Connection con=null;
    /**
     * Creates new form ModificarPro
     */
    public ModificarPro(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnModificar.setText("Buscar clave");
                                ...
                                if(txtCasa.getText().length() == 10){
                                    ...
                                    if(txtCelular.getText().length() == 10){
                                        ...
                                        try{
                                            ...
                                            con = DriverManager.getConnection(URL,user,pass);
                                            st = con.createStatement();
                                            res = st.executeUpdate("execute modificarPV '"+s+"','"+ap+"','"+am+"','"+txtCasa.getText()+"','"+txtCelular.getText()+"','"+txtId.getText()+"'");
