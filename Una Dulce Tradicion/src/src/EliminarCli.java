 ...
 * @author eliez
 */
public class EliminarCli extends javax.swing.JDialog {
     ...
     */
    public EliminarCli(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        Statement st;
        int res;
        int ventana = JOptionPane.showOptionDialog (null, "Esta seguro que quiere borrar este cliente?, lo datos no se podran recuperar","Confirmar Eliminacion", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,null, opcion,opcion[0]);
        if(ventana == 0){
            ...
            try{
                ...
                con = DriverManager.getConnection(URL,user,pass);
                st = con.createStatement();
                res = st.executeUpdate("execute eliminarCliente'"+txtId.getText()+"'");
